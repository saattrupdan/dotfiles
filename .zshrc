...
alias rc='cp ~/.*rc ~/gitsky/dotfiles; cd ~/gitsky/dotfiles; git add .; git commit -m "chore: Update dot files"; git pull; git push; cd -; cp ~/gitsky/dotfiles/.*rc ~/; echo "Dot files synced up!"'
