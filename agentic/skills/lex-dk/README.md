...
- `lexdk` CLI — standard library only (`pipx install -e .` from this directory)
...
# Use the lexdk CLI (see SKILL.md for all subcommands)
lexdk status
lexdk autocomplete Marie
lexdk article Marie_Curie
```
