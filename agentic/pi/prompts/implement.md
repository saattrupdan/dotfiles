---
description: Full implementation flow with review only when risk warrants it.
---
...
3. **Review only when warranted.** Skip review for simple or low-risk changes. Call one
...
5. **Block.** If the reviewer returns "Block", surface the verdict and findings and ask
