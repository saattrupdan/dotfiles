---
name: builder
description: Implement one scoped change. Full read/write/bash.
mode: subagent
permission:
  read: allow
  edit: allow
  ...
  todowrite: deny
worktree: true
skills: [commit, python, fastapi, vue, sqlmodel, full-stack, slides, recursive-language-model, agent-browser]
---
