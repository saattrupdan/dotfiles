...
branch into the main branch (always merge with `--no-ff` flag to ensure that we have a
merge commit), after which you can remove the worktree's branch. If you experience any
merge conflicts, you have to report those back to the user.
